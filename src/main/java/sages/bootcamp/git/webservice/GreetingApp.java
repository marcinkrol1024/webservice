...
import sages.bootcamp.git.webservice.service.RafalLeszczynskiGreetingServiceImpl;
...
public class GreetingApp {
  ...
  public GreetingService provideGreetingService() {
    return new AggregateGreetingService (new RafalLeszczynskiGreetingServiceImpl()/* Tutaj umieszczamy swoje implementacje :) */);
  }
}
